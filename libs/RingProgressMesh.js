...
void main (void)
{
  ...
  float circleValue = circle(vUv, center, 0.5);
  float arcValue = arc(vUv, center, 0.4, uProgress);

  // Mix the colors based on the arc value
  color = mix(bgColor, arcColor, arcValue);
